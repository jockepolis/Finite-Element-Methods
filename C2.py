...
vtkfile_u = File('LotkaVolterraSweden/u.pvd')
vtkfile_u0 = File('LotkaVolterraSweden/u0.pvd')
...
with open('populations3.csv', 'w') as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=',')
    csv_writer.writerow(popu) 
